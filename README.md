...
| `github-pat` | for reviews / description edits | Fetches PR reviews, re-requests reviewers whose approval went stale or was dismissed (approval cascade), and edits the PR body (`edit_pr_description`). |
