...
- [x] The merge deletes no approval subtask but a reviewer's own duplicate: creating an FYI never runs the tier cascade cleanup, so another tier's record survives and the new subtask is not swept away with it.
