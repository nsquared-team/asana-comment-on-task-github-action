...
- [x] The CI sandbox block refreshes correctly: the input is never expanded as a replacement pattern, the author's own sections between two stale blocks survive, and a block whose trailing sentence was edited away still refreshes instead of freezing forever.
